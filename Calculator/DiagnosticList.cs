...
{
    /// <summary>
    /// A class that acts as a <see cref="Diagnostic" /><see cref="List{T}" /> and also as a
    /// <see cref="IProgress{T}" />. Used as the diagnosticReporter in the parser and lexer by default.
    /// </summary>
