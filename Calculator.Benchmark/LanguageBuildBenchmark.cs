    ...
    public class LanguageBuildBenchmark
    {
        ...
        public CalculatorLanguage GetCalculatorLanguage2 ( )
        {
            ...
            return new CalculatorLanguage ( StringComparer.InvariantCultureIgnoreCase )
                ...
                .AddBinaryOperator ( Associativity.Left, "|", 1, ( left, right ) => ( ( Int64 ) left ) | ( ( Int64 ) right ) )
                .AddBinaryOperator ( Associativity.Left, "∨", 1, ( left, right ) => ( ( Int64 ) left ) | ( ( Int64 ) right ) )
                .AddBinaryOperator ( Associativity.Left, "xor", 2, ( left, right ) => ( ( Int64 ) left ) ^ ( ( Int64 ) right ) )
                .AddBinaryOperator ( Associativity.Left, "⊻", 2, ( left, right ) => ( ( Int64 ) left ) ^ ( ( Int64 ) right ) )
                .AddBinaryOperator ( Associativity.Left, "⊕", 2, ( left, right ) => ( ( Int64 ) left ) ^ ( ( Int64 ) right ) )
                .AddBinaryOperator ( Associativity.Left, "&", 3, ( left, right ) => ( ( Int64 ) left ) & ( ( Int64 ) right ) )
                .AddBinaryOperator ( Associativity.Left, "∧", 3, ( left, right ) => ( ( Int64 ) left ) & ( ( Int64 ) right ) )
                .AddBinaryOperator ( Associativity.Left, ">>", 4, ( left, right ) => ( ( Int64 ) left ) >> ( ( Int32 ) right ) )
                .AddBinaryOperator ( Associativity.Left, "<<", 4, ( left, right ) => ( ( Int64 ) left ) << ( ( Int32 ) right ) )
